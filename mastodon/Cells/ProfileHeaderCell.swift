...
class ProfileHeaderCell: SwipeTableViewCell {
    ...
    func configure(_ status: Account) {
        ...
        if status.fields.count > 0 {
            ...
            contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-150-[name]-4-[artist]-15-[episodes]-15-[follows]-4-[date]-20-|", options: [], metrics: nil, views: viewsDict))
        }
